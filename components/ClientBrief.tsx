  ...
  return (
    <div className="min-h-screen bg-retro-bg flex flex-col">
      ...
      <header className="flex items-center justify-between px-4 py-3 border-b border-green-900/30 bg-slate-900/50">
        ...
        <span className="font-heading text-terminal-green text-sm">CLIENT BRIEF</span>
      </header>
      ...
      <main className="flex-1 overflow-y-auto p-4 sm:p-8 max-w-3xl mx-auto w-full">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="font-heading text-terminal-green text-base sm:text-lg mb-1">
          ...
          <div className="mt-4 flex gap-2">
            ...
            <span className="px-2 py-1 text-base font-body border border-gray-600 text-gray-400">
        ...
        {scenario.company_why_contacted ? (
          <motion.section
            ...
            className="mb-6"
          >
            <h2 className="font-heading text-terminal-green text-base mb-3 border-b border-green-900/30 pb-2">
              WHY THEY CONTACTED US
            </h2>
...
<h3 className="font-heading text-terminal-green text-base mb-1">
            ...
            {scenario.contact_communication_style && (
              <div className="mt-4 pt-4 border-t border-green-900/30">
                <p className="font-body text-base text-gray-500 uppercase mb-2">Communication Style</p>
                <p className="font-body text-gray-400 text-base leading-relaxed">
                  {scenario.contact_communication_style}
                </p>
              </div>
